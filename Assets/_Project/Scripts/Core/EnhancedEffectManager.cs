...
/// <summary>
/// Enhanced Effect Manager - Qu?n l� vi?c t?o, ??nh v? v� h?y effect prefabs
/// ??m b?o effect xu?t hi?n ?�ng v? tr� va ch?m v� ???c h?y sau khi animation ho�n t?t
/// </summary>
public class EnhancedEffectManager : MonoBehaviour
{
    ...
    /// <summary>
    /// T?o effect t?i v? tr� va ch?m ch�nh x�c v?i auto-destroy
    /// </summary>
        ...
        Quaternion rotation = default, Transform parent = null, float? customLifetime = null)
    {
        ...
        // Instantiate effect t?i v? tr� ch�nh x�c
    ...
    /// <summary>
    /// T?o effect t?i v? tr� va ch?m v?i m?c ti�u c? th?
    /// </summary>
...
/// <summary>
/// Component t? ??ng h?y effect sau khi animation ho�n t?t
/// </summary>
...
/// <summary>
/// Component l�m effect follow target (cho continuous effects)
/// </summary>
