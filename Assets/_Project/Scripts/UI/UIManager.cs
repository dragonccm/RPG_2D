...
/// <summary>
/// UI Manager - Qu?n l� to�n b? h? th?ng UI v?i Legacy Skill UI
/// </summary>
public class UIManager : MonoBehaviour
{
    ...
    void Update()
    {
        // Tab toggle ?� ???c x? l� trong PlayerController
    }

    /// <summary>
    /// T? ??ng t�m c�c UI components theo hierarchy structure
    /// </summary>
    ...
    {
        // T? ??ng t�m c�c component kh�c n?u ch?a ???c assign
        if (playerUI == null)
            playerUI = FindFirstObjectByType<PlayerUI>();
